							...
							<div class="well well-sm">
								<div class="media">
									...
									<div class="media-body">
										...
										<h5><label>City: <label><span class="label label-info">Porto</span></h5>	
										<h5><label>Status: <label><span class="label label-success">Active</span></h5>	
									</div>
								</div>
							</div>
						</div>
		  ...
		  <div class="row">
			<div class="col-md-12">
					<br><br>
						...
						<div class="col-md-6">
							<div class="input-group">
							  <span class="input-group-addon">Previous Password</span>
