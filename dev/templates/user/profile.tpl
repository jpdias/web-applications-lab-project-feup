        ...
        <div class="col-md-12">
          ...
          <div class="col-md-6">
            <div class="input-group">
              ...
              <input type="text" class="form-control" name="firstname" placeholder="First Name" value="{$result.firstname}">
            </div> 
            <br>
          </div>
          ...
          <div class="col-md-6">
            <div class="input-group">
              ...
              <input type="text" class="form-control" name="email" placeholder="Email" value="{$result.email}" readonly>
            </div>
